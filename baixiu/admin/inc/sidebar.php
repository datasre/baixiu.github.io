<!-- 可以使用$_SERVER['PHP_SELF']来取代$current_page,且每个变量中还不需要定义$current_page变量了 -->
<?php 
  ...
  <div class="aside">
    ...
    <ul class="nav">
      ...
      <li  <?php echo in_array($current_page,$menu_posts)?' class="active"':'';?> >
        ...
        <ul id="menu-posts"  id="menu-settings" class="collapse <?php echo in_array($current_page,$menu_posts)?' in':''; ?>" >
